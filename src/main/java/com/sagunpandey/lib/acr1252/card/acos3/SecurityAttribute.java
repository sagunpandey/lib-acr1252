...
public class SecurityAttribute {
  ...
  public SecurityAttribute(byte securityAttribute) {
    if ((securityAttribute & (byte) 0x01) == (byte) 0x80)
      issuerCode_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x40)
      pin_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x20)
      accessCondition5_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x10)
      accessCondition4_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x08)
      accessCondition3_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x04)
      accessCondition2_ = true;

    if ((securityAttribute & (byte) 0x01) == (byte) 0x02)
